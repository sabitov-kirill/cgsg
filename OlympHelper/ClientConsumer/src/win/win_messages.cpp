 ...
 * RETURNS: None.
 */
VOID win::OnHotkey(INT HotkeyID, UINT HotKeyModifiers, UINT VirtualKey)
{
  Hotkey(HotkeyID);
} /* End of 'win::OnHotkey' function */

/* WM_ACTIVATE window message handle function.
 * ARGUMENTS: ...
 * RETURNS: None.
 */
VOID win::OnKeyboardClick(INT KeyCode, UINT Params)
{
  KeyboardClick(KeyCode);
} /* End of 'win::OnKeyboardClick' function */
